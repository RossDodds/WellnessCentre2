...
public class MealDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable ="CREATE TABLE " + MEAL_TABLE + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, " + MEAL_NAME + " TEXT, " + TOTAL_CALORIES + " INT, " + DATE_OF_MEAL + " TEXT )";
    ...
    public boolean addMeal(String mealName, int totalCalories, String dateOfMeal){
        ...
        // result of double from inserting into the database indicates if the opperation was
    ...
    public List<Meal> getMeals(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                Meal dbNewMeal = new Meal(dbMealName, dbIngredientList,dbMealDate,dbTotalCalories);
